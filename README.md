...
TODO: download the latest release APK from [Releases](https://github.com/tyleryancey/light-grimoire/releases) and sideload it via Android Studio / adb, per the LightOS developer docs.

## LP3 / LightOS compatibility

TODO: state what was actually tested — emulator vs. physical Light Phone III, LightOS version. Tool ID: `dev.tyler.grimoire`.

## Build from source

```
git clone https://github.com/tyleryancey/light-grimoire.git
cd $(basename tyleryancey/light-grimoire)
