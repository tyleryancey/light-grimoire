...
def gen_events(armor: dict[str, dict]) -> dict:
    ...
    scenarios = [
        ...
        scen("temp hp correction can lower the number", rogue, [{"type": "tempDelta", "delta": -2}]),
        scen("temp hp correction clamps at zero", rogue, [{"type": "tempDelta", "delta": -20}]),
        scen("temp hp correction stacks (unlike temp)", rogue, [{"type": "tempDelta", "delta": 3}, {"type": "tempDelta", "delta": 3}]),
        scen("temp hp correction at zero hp still absorbs damage", pal, [{"type": "tempDelta", "delta": 6}, {"type": "damage", "amount": 5}]),
        scen("temp hp correction applies even to the dead", pal, [{"type": "deathSave", "d20": 3}, {"type": "deathSave", "d20": 3}, {"type": "tempDelta", "delta": 6}]),
        ...
        scen("revive clears the saves and leaves hp at zero", pal, [{"type": "deathSave", "d20": 3}, {"type": "deathSave", "d20": 3}, {"type": "revive"}]),
        scen("revive then a death save counts again", pal, [{"type": "deathSave", "d20": 3}, {"type": "deathSave", "d20": 3}, {"type": "revive"}, {"type": "deathSave", "d20": 15}]),
        scen("revive on a character who is up clears nothing but the saves", cleric, [{"type": "revive"}]),
        ...
        scen("spend hit die does not revive the dead", pal, [{"type": "deathSave", "d20": 3}, {"type": "deathSave", "d20": 3}, {"type": "spendHitDie", "die": 10, "roll": 6}]),
        scen("spend hit die on a dead character does not even raise when none are left", pal, [{"type": "deathSave", "d20": 3}, {"type": "deathSave", "d20": 3}, {"type": "spendHitDie", "die": 8, "roll": 4}]),
